...
public class Lozinki {
    public static void main(String[] args) throws IOException {
        ...
        while (true){
            ...
            String [] parts2 = text.split("\\s+");
            String ime = parts2[0];
            String lozinka = parts2[1];

            SLLNode<MapEntry<String, String>> user = table.search(ime);

            if(user.element.value.equals(lozinka)){
